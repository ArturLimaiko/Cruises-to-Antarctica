...
/* harmony import */ var _modules_header_burger__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/header-burger */ "./js/modules/header-burger.js");
...
var inputsPhone = document.querySelectorAll('[data-phone-number]');
// ---------------------------------
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_header_burger__WEBPACK_IMPORTED_MODULE_3__["getHeaderBurger"])();
  Object(_modules_scroll__WEBPACK_IMPORTED_MODULE_4__["scroll"])();
...
inputsPhone.forEach(function (el) {
...
/*!*************************************!*\
  !*** ./js/modules/header-burger.js ***!
  \*************************************/
/*! exports provided: getHeaderBurger */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getHeaderBurger", function() { return getHeaderBurger; });
var getHeaderBurger = function getHeaderBurger() {
  var header = document.querySelector('.header');
  if (!header) {
    return;
  }
  var headerButton = header.querySelector('.header__button');
  var headerLinks = header.querySelectorAll('.header__link');
  header.classList.remove('header--nojs');
  var onToggleMenu = function onToggleMenu() {
  ...
  document.addEventListener('click', function (e) {
    var click = e.composedPath().includes(header);
    if (!click) {
